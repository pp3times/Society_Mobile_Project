    ...
    return (
      <View style={{ flexDirection: "row", alignItems: "center" }}>
        {seats.map((seat, index) => (
          <Text key={index} style={{ marginTop: 4, fontSize: 17, paddingRight: 10 }}>
            {seat}
          </Text>
        ))}
      </View>
  ...
  return (
    <UserLayout>
      <SafeAreaView>
        ...
        >
          <View style={{ padding: 10 }}>
            <Text style={{ marginBottom: 4, fontSize: 15, fontWeight: "500" }}>
              ค่าจองโต๊ะละ 10 บาท {/* <Text style={{ color: "#CE0000" }}>( กรุณามาก่อนเวลา 20:00 น. )</Text> */}
            </Text>
            {seats.length > 0 ? showSeats() : <Text style={{ fontSize: 18 }}>No seats selected</Text>}
          </View>
          <View
            style={{
          ...
          >
            <Text style={{ width: 100, color: "#CE0000" }}>กรุณามาก่อนเวลา 20:00 น.</Text>
          </View>
        </View>
        <Pressable
          style={{
        ...
        >
          {seats.length > 0 ? <Text style={{ fontSize: 17, fontWeight: "500" }}>จำนวนที่นั่ง {seats.length} </Text> : <Text></Text>}
          <Text></Text>
          <Pressable onPress={subscribe}>
            <Text style={{ fontSize: 17, fontWeight: "600" }}>ชำระค่าจอง {total} บาท</Text>
          </Pressable>
        </Pressable>
      </SafeAreaView>
    </UserLayout>
